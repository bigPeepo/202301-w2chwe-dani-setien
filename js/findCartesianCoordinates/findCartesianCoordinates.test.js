...
describe("Given a findCartesianCoordinates function", () => {
  describe("When it receives the position 2 and an unarranged board in list form [0,1,2,3,4,5,6,7,8]", () => {
  ...
  describe("When it receives the position 0 and an unarranged board in list form [00,01,02,03,04,05,06,07,08,09,10,11,12,13,14,15,16,17,18,18,20,21,22,23,24]", () => {
  ...
  describe("When it receives the position 24 and an unarranged board in list form [00,01,02,03,04,05,06,07,08,09,10,11,12,13,14,15,16,17,18,18,20,21,22,23,24]", () => {
